      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column nav-flat" data-widget="treeview" role="menu" data-accordion="false">
         <li class="nav-item dropdown">
          ...
          <li class="nav-item dropdown">
            <a href="./index.php?page=internet_tracking" class="nav-link nav-internet_tracking">
          ...
          <li class="nav-item dropdown">
            <a href="./index.php?page=email_monitoring" class="nav-link nav-email_monitoring">
          ...
          <li class="nav-item dropdown">
            <a href="./index.php?page=employee_alert" class="nav-link nav-employee_alert">
